 ...
 let goods2 = new Goods('Flooop', '$300', 'https://www.freelogodesign.org/Content/img/logo-samples/flooop.png', 10, '.out-4');
 goods2.draw();
 ...
 let goods3 = new Goods2('Flooop', '$300', 'https://www.freelogodesign.org/Content/img/logo-samples/flooop.png', 10, '.out-6');
 goods3.draw();
 console.log(goods3)
 ...
 let valid = new Valid('Tony', 'qweqe');
 valid.validate()
 ...
 let valid1 = new Valid('Tony', 'qweqeer');
 valid1.validate()
 ...
 let valid3 = new Valid2('rsrar', 'qweqe')
 valid3.validate()
 console.log(valid3);